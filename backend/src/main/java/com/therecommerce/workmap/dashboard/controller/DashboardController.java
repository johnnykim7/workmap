...
public class DashboardController {
    ...
    public ResponseDto<PageResponse<WorkItemDtos.Response>> blocked(
        ...
        return ResponseDto.success(
                dashboardService.list("BLOCKED", projectId, new PageRequest(page, size), userId));
    }
    ...
    public ResponseDto<PageResponse<WorkItemDtos.Response>> delayed(
            ...
            @AuthUserInfo("userId") Long userId) {
        return ResponseDto.success(
                dashboardService.list("DELAYED", projectId, new PageRequest(page, size), userId));
    }
    ...
    public ResponseDto<PageResponse<WorkItemDtos.Response>> unassigned(
            ...
            @AuthUserInfo("userId") Long userId) {
        return ResponseDto.success(
                dashboardService.list("UNASSIGNED", projectId, new PageRequest(page, size), userId));
    }
    ...
    public ResponseDto<DashboardDtos.Metrics> metrics(
            @RequestParam(required = false) Long projectId,
            @AuthUserInfo("userId") Long userId) {
        return ResponseDto.success(dashboardService.metrics(projectId, userId));
    }
